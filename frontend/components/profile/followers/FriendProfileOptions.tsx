            ...
            <BottomSheet
                ...
                <BottomSheetScrollView contentContainerStyle={styles.bottomSheetContentContainer}>
                    <View style={styles.profileOptionsContainer}>
                        <Button title="Block user" containerStyle={styles.profileOptionsButtonContainer} textStyle={[styles.profileOptionsText, { color: "#FF4747" }]}/> 
                        <Button title="Report user" containerStyle={styles.profileOptionsButtonContainer} textStyle={[styles.profileOptionsText, { color: "#FF4747" }]}/> 
                        <Button title="Remove follower" containerStyle={styles.profileOptionsButtonContainer} textStyle={[styles.profileOptionsText, { color: "#000" }]}/> 
