    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const avgRating = parseFloat(
          (dishesData.reduce((acc, dish) => acc + dish.averageRating.overall, 0) / dishesData.length).toFixed(1)
        );
        ...
        const returnRate = parseFloat(
          (dishesData.reduce((acc, dish) => acc + dish.returningPercentage, 0) / dishesData.length).toFixed(1)
        );
      ...
      >
        ...
        <View style={styles.dishesContainer}>
          ...
          <View style={styles.dishList}>
            {dishes.map(dish => renderDishRow(dish))}
          </View>
        </View>
      </ScrollView>
    </ThemedView>
